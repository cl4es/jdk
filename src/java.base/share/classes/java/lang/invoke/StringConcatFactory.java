...
public final class StringConcatFactory {
    ...
    private static MethodHandle generateMHInlineCopy(MethodType mt, String[] constants) {
        ...
        MethodHandle[] objectFilters = null;
        ...
        for (int i = 0; i < ptypes.length; i++) {
            ...
            if (cl == byte.class || cl == short.class) {
                ...
                if (objectFilters == null) {
                    objectFilters = new MethodHandle[ptypes.length];
                }
                objectFilters[i] = objectStringifier();
        ...
        if (objectFilters != null) {
            mh = MethodHandles.filterArguments(mh, 0, objectFilters);
        }
        if (floatFilters != null) {
